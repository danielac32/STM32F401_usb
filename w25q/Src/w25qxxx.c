...
{   
    ...
    // Configurar el pin GPIO para SCK (GPIOA Pin 5)
    GPIO_InitStruct.Pin = GPIO_PIN_5;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;           // Modo de salida con pull-up/pull-down
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;     // Alta velocidad
    GPIO_InitStruct.Pull = GPIO_PULLUP;               // Pull-up
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;        // Configurar la función alternativa para SPI1
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    // Configurar el pin GPIO para MISO (GPIOA Pin 6)
    GPIO_InitStruct.Pin = GPIO_PIN_6;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    // Configurar el pin GPIO para MOSI (GPIOA Pin 7)
    GPIO_InitStruct.Pin = GPIO_PIN_7;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    // Configurar el pin GPIO para CS (GPIOA Pin 4)
    GPIO_InitStruct.Pin = GPIO_PIN_4;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;      // Modo de salida push-pull
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;     // Baja velocidad es suficiente para CS
